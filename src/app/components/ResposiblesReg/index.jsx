...
// const [showForm, setShowForm] = useState(true);
  ...
  async function addResposibles  (){
  catformData.append("name",name)
  catformData.append("lname",lname)
  catformData.append("mobile",mobile)
  axios.post(`${BASE_URL}/tblresponsible`,catformData).then(res=>{window.alert(res.status==201?"گروه شما اضافه شد":"دوباره تلاش کنید")}).catch(err=>(window.alert(err)))
  }
